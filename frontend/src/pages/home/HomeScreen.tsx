...
import { MOVIE_CATEGORIES, TV_CATEGORIES, ORGINAL_IMG_BASE_URL } from "../../utils/constants";
...
const HomeScreen = () => {
  ...
  // Handle case where trendin gContent is null
  if (!trendingContent) {
    return (
  ...
  return <>
    <div className="relative h-screen text-white">
      ...
      {imgLoading && (<div className='absolute top-0 left-0 w-full h-full bg-black/70 flex items-center justify-center shimmer -z-10' />
      )}
      <img
